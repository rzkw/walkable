...
- Start > type "this PC" > Properties > Advanced system settings > Advanced tab
...
I installed [WSL2](https://learn.microsoft.com/en-us/windows/wsl/install) to install Linux on my RAM-constrained hardware without needing to run a virtual machine (VM). The distribution I chose was Ubuntu seeing as it's well documented.
...
After a restart, I installed [Chocolatey, a package manager](https://chocolatey.org/how-chocolatey-works) to easily keep my packages up to date later on. I then installed the following dev tools and utilities:

Dev tools: Git, Visual Studio Code, Node.js, and Python
```
choco install git -y
...
System utilities: wget, curl, and 7zip
```
...
- [wget vs curl: What Are the Differences?](https://phoenixnap.com/kb/wget-vs-curl)
