...
_“you are a software engineering tutor at a leading university. create a detailed step by step tutorial on converting an old windows 10 laptop into a dev server. include instructions on updating RAM module”_
...
<CodeBlock language="powershell" title="Remove Windows Bloatware & Optimize Performance">
  {`# Open PowerShell as Administrator
  # Remove unnecessary Windows apps that consume memory
...
- [PowerShell app performance settings code]()
